...
def fetch_poster(movie_id):
    url = "https://api.themoviedb.org/3/movie/{}?api_key=51603626eb2f44555626a43c07195c89".format(int(movie_id))
...
def movie_data(movie_name):
    ...
    url_credict = "https://api.themoviedb.org/3/movie/{}/credits?api_key=51603626eb2f44555626a43c07195c89".format(int(movie_id))
...
def actor_data(movie_name):
    movie_id = movies[movies['title'] == movie_name].movie_id
    url = "https://api.themoviedb.org/3/movie/{}/credits?api_key=51603626eb2f44555626a43c07195c89".format(int(movie_id))
